...
class _MyAppState extends State<MyApp> {
  ...
  void performSearch() {
    ...
    filteredData = tableData.where((item) {
      ...
      bool matchDate = item.date.toString().toLowerCase().contains(date.toLowerCase());
...
List<dynamic> Moods = [];
  ...
  void initState() {
    super.initState();
    filteredData = List.from(tableData); // Initialize filteredData with all tableData items
          ...
          Row(
            children: [
              Expanded(
                child: Padding(
                  ...
                  child: TextField(
                    ...
                    style: TextStyle(color: Color(0xFFFBF8BE)), // Set text color to Pale Yellow
                    decoration: InputDecoration(
                      labelText: "Search by matricule",
                      labelStyle: TextStyle(color: Color(0xFFFBF8BE)), // Set label color to Pale Yellow
                      enabledBorder: UnderlineInputBorder(
                        borderSide: BorderSide(color: Color(0xFFFBF8BE)), // Set underline color to Pale Yellow
                      ),
                      focusedBorder: UnderlineInputBorder(
                        borderSide: BorderSide(color: Color(0xFFFBF8BE)), // Set focused underline color to Pale Yellow
                      ),
                    ),
                  ),
                ),
              ...
              ElevatedButton(
                ...
                child: Text(
                  "Search",
                  style: TextStyle(color: Color(0xFF234E70)), // Set text color to Royal Blue
                ),
              ),
            ],
          ),
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  ...
                  child: Card(
                    color: Color(0xFF234E70), // Set card background color to Royal Blue
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Column(
...
class ApiService {
  ...
  static const String baseUrl = 'http://10.0.2.2:8080/Humeur_salarie/api/allmoods';
